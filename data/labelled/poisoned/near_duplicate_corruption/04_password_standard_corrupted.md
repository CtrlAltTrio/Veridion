...
This standard defines password length, storage, reuse, and reset requirements. It is the controlled internal source for this topic. Northwind Systems uses it to make decisions consistently across Portland, Austin, Dublin, and remote teams. Readers should check the owner and review date before acting, particularly when a customer contract, regional rule, or active incident may affect the normal workflow.

## Authoritative facts

- Workforce passwords must contain at least 8 characters.
- Passwords may not be shared or reused across personal services.
- Routine password rotation is not required unless compromise is suspected.
- Password managers approved by Security are required for shared service credentials.
