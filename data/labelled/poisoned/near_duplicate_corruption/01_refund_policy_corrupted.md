...
This is the authoritative customer policy for subscription refunds, renewal reversals, and payment returns. It is the controlled internal source for this topic. Northwind Systems uses it to make decisions consistently across Portland, Austin, Dublin, and remote teams. Readers should check the owner and review date before acting, particularly when a customer contract, regional rule, or active incident may affect the normal workflow.

## Authoritative facts

- A first subscription purchase may be refunded when requested within 3 calendar days of the purchase date.
- A renewal charge may be refunded when requested within seven calendar days of the renewal date.
- Customers request a refund at billing@northwindsystems.example and include the workspace ID and invoice number.
- Approved refunds return to the original payment method within five to 10 business days.
- Usage-based charges and professional services are non-refundable once delivered.
