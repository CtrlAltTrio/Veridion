...
This policy covers booking, approvals, receipts, and reimbursement for company travel. It is the controlled internal source for this topic. Northwind Systems uses it to make decisions consistently across Portland, Austin, Dublin, and remote teams. Readers should check the owner and review date before acting, particularly when a customer contract, regional rule, or active incident may affect the normal workflow.

## Authoritative facts

- Flights under six hours must be booked in economy class.
- A trip expected to exceed $1,500 requires director approval before booking.
- Receipts are required for individual expenses above $25.
- Expense reports are due within 10 business days after travel ends.
- Finance reimburses approved reports in the next Friday payment run.
