...
This runbook coordinates status-page and direct customer communication during major outages. It is the controlled internal source for this topic. Northwind Systems uses it to make decisions consistently across Portland, Austin, Dublin, and remote teams. Readers should check the owner and review date before acting, particularly when a customer contract, regional rule, or active incident may affect the normal workflow.

## Authoritative facts

- The first public status update is posted within 30 minutes of confirming an outage.
- Updates continue at least every 60 minutes while impact remains active.
- Enterprise account teams receive a briefing within one hour.
- A customer-facing incident summary is published within five business days.
