...
This runbook explains when a case moves from frontline support to engineering or leadership. It is the controlled internal source for this topic. Northwind Systems uses it to make decisions consistently across Portland, Austin, Dublin, and remote teams. Readers should check the owner and review date before acting, particularly when a customer contract, regional rule, or active incident may affect the normal workflow.

## Authoritative facts

- A P1 case is paged to the incident commander immediately.
- A P2 case with no workaround after four business hours is escalated to engineering.
- The support duty manager reviews any case open longer than 10 business days.
- Every escalation must include reproduction steps, impact, and a timeline.
