...
This guide explains routine release timing, maintenance notices, and public API deprecations. It is the controlled internal source for this topic. Northwind Systems uses it to make decisions consistently across Portland, Austin, Dublin, and remote teams. Readers should check the owner and review date before acting, particularly when a customer contract, regional rule, or active incident may affect the normal workflow.

## Authoritative facts

- Routine production releases occur Tuesday and Thursday at 18:00 UTC.
- Planned maintenance is announced at least 72 hours in advance.
- Public API removals receive at least six months of deprecation notice.
- Emergency security releases may occur outside the routine window.
