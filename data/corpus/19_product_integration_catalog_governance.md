...
This standard defines supported integrations and the review process for catalog publication. It is the controlled internal source for this topic. Northwind Systems uses it to make decisions consistently across Portland, Austin, Dublin, and remote teams. Readers should check the owner and review date before acting, particularly when a customer contract, regional rule, or active incident may affect the normal workflow.

## Authoritative facts

- The catalog is reviewed on the first Wednesday of each month.
- OAuth integrations must request the minimum documented scopes.
- A new public integration requires security and privacy review.
- A deprecated integration remains listed with a warning for at least 90 days.
