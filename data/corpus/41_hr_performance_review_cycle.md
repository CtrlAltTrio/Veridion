...
This guide defines goal setting, feedback windows, calibration, and review delivery. It is the controlled internal source for this topic. Northwind Systems uses it to make decisions consistently across Portland, Austin, Dublin, and remote teams. Readers should check the owner and review date before acting, particularly when a customer contract, regional rule, or active incident may affect the normal workflow.

## Authoritative facts

- Formal performance reviews occur twice each year, in March and September.
- Self-reviews remain open for 10 calendar days.
- Managers deliver completed reviews within five business days after calibration.
- Goals must include at least one measurable outcome.
