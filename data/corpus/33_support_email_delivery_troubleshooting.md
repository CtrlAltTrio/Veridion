...
This runbook covers suppressed recipients, domain records, queues, and escalation evidence. It is the controlled internal source for this topic. Northwind Systems uses it to make decisions consistently across Portland, Austin, Dublin, and remote teams. Readers should check the owner and review date before acting, particularly when a customer contract, regional rule, or active incident may affect the normal workflow.

## Authoritative facts

- Transactional mail is retried for up to 24 hours.
- A recipient is suppressed after three permanent bounces.
- DNS checks require SPF and DKIM evidence.
- Cases involving more than 1,000 delayed messages are escalated to Messaging Operations.
