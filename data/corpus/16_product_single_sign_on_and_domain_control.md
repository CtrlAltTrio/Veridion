...
**Owner:** Identity Product Team
**Last reviewed:** 2026-04-30
**Applies to:** Northwind Systems employees and relevant customer workspaces

## Purpose

This page documents SSO availability, supported protocols, enforcement, and verified domains. It is the controlled internal source for this topic. Northwind Systems uses it to make decisions consistently across Portland, Austin, Dublin, and remote teams. Readers should check the owner and review date before acting, particularly when a customer contract, regional rule, or active incident may affect the normal workflow.

## Authoritative facts

- Enterprise includes SAML 2.0 and OpenID Connect single sign-on.
- Growth may purchase SSO as an add-on.
- Starter does not support organization-wide SSO.
- An administrator must verify a domain by DNS TXT record before enforcing SSO.
