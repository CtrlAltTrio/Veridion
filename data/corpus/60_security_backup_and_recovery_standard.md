...
This standard defines backup frequency, encryption, recovery objectives, and restore testing. It is the controlled internal source for this topic. Northwind Systems uses it to make decisions consistently across Portland, Austin, Dublin, and remote teams. Readers should check the owner and review date before acting, particularly when a customer contract, regional rule, or active incident may affect the normal workflow.

## Authoritative facts

- Production backups are encrypted and created at least every four hours.
- The recovery point objective is four hours.
- The recovery time objective is eight hours.
- Restore tests occur quarterly and results are retained for one year.
