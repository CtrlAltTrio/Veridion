...
This page lists production data regions and the rules for selecting or changing residency. It is the controlled internal source for this topic. Northwind Systems uses it to make decisions consistently across Portland, Austin, Dublin, and remote teams. Readers should check the owner and review date before acting, particularly when a customer contract, regional rule, or active incident may affect the normal workflow.

## Authoritative facts

- The United States region is hosted in Oregon.
- The European Union region is hosted in Dublin.
- Enterprise customers choose a region during provisioning.
- A residency migration requires at least 15 business days of planning.
