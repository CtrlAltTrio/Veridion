...
This runbook provides checkpoints for importing data into a Northwind workspace. It is the controlled internal source for this topic. Northwind Systems uses it to make decisions consistently across Portland, Austin, Dublin, and remote teams. Readers should check the owner and review date before acting, particularly when a customer contract, regional rule, or active incident may affect the normal workflow.

## Authoritative facts

- Imports above 100,000 records require a dry run.
- The customer approves a field mapping before production import.
- Migration files are deleted seven days after validation.
- A rollback copy is retained for 14 days after cutover.
