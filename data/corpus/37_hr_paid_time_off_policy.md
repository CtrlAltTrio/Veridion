...
This policy explains annual vacation grants, carryover, requests, and manager planning. It is the controlled internal source for this topic. Northwind Systems uses it to make decisions consistently across Portland, Austin, Dublin, and remote teams. Readers should check the owner and review date before acting, particularly when a customer contract, regional rule, or active incident may affect the normal workflow.

## Authoritative facts

- Full-time employees receive 20 paid vacation days each calendar year.
- Up to five unused vacation days carry into the next year.
- Carried days expire on 31 March.
- Requests for five or more consecutive days should be submitted 30 days in advance.
