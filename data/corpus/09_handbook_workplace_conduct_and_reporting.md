...
This policy explains respectful conduct standards and confidential reporting options. It is the controlled internal source for this topic. Northwind Systems uses it to make decisions consistently across Portland, Austin, Dublin, and remote teams. Readers should check the owner and review date before acting, particularly when a customer contract, regional rule, or active incident may affect the normal workflow.

## Authoritative facts

- Conduct concerns may be sent to people@northwindsystems.example.
- The independent ethics line is available 24 hours a day.
- People Operations acknowledges a report within two business days.
- Retaliation concerns are escalated directly to the General Counsel.
