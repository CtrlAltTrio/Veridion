...
This runbook defines severity levels and acknowledgement targets for customer cases. It is the controlled internal source for this topic. Northwind Systems uses it to make decisions consistently across Portland, Austin, Dublin, and remote teams. Readers should check the owner and review date before acting, particularly when a customer contract, regional rule, or active incident may affect the normal workflow.

## Authoritative facts

- P1 means a production service is unavailable or customer data is at immediate risk.
- P1 cases are acknowledged within 15 minutes, 24 hours a day.
- P2 cases are acknowledged within two business hours.
- P3 cases are acknowledged within one business day.
