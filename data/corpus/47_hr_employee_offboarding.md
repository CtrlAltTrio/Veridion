...
This checklist coordinates access removal, final pay, records, and equipment return. It is the controlled internal source for this topic. Northwind Systems uses it to make decisions consistently across Portland, Austin, Dublin, and remote teams. Readers should check the owner and review date before acting, particularly when a customer contract, regional rule, or active incident may affect the normal workflow.

## Authoritative facts

- System access ends by 17:00 local time on the final workday.
- Managers transfer owned documents before access removal.
- Company equipment is due within five calendar days.
- Payroll provides final-pay information at least two business days before departure.
