...
This standard defines approved factors and enforcement for workforce and privileged access. It is the controlled internal source for this topic. Northwind Systems uses it to make decisions consistently across Portland, Austin, Dublin, and remote teams. Readers should check the owner and review date before acting, particularly when a customer contract, regional rule, or active incident may affect the normal workflow.

## Authoritative facts

- MFA is required for every workforce account.
- Security keys are required for production administrators.
- TOTP authenticator applications are approved for standard accounts.
- SMS is not an approved MFA factor.
