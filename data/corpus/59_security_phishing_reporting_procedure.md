...
This procedure tells employees how to report suspicious messages and protect evidence. It is the controlled internal source for this topic. Northwind Systems uses it to make decisions consistently across Portland, Austin, Dublin, and remote teams. Readers should check the owner and review date before acting, particularly when a customer contract, regional rule, or active incident may affect the normal workflow.

## Authoritative facts

- Employees use the Report Phish button whenever available.
- A clicked phishing link must be reported within 15 minutes.
- Employees should not forward suspicious attachments.
- Security Operations acknowledges high-risk reports within 30 minutes.
