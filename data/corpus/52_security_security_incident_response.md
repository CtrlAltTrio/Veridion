...
This plan defines security incident declaration, command roles, and evidence preservation. It is the controlled internal source for this topic. Northwind Systems uses it to make decisions consistently across Portland, Austin, Dublin, and remote teams. Readers should check the owner and review date before acting, particularly when a customer contract, regional rule, or active incident may affect the normal workflow.

## Authoritative facts

- The on-call analyst acknowledges a security page within 15 minutes.
- A SEV-1 security incident appoints an incident commander and scribe.
- Evidence is stored in the restricted incident vault.
- A lessons-learned review occurs within five business days after containment.
