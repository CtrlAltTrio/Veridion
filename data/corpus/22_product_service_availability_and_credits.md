...
This policy defines the production availability objective and monthly service-credit tiers. It is the controlled internal source for this topic. Northwind Systems uses it to make decisions consistently across Portland, Austin, Dublin, and remote teams. Readers should check the owner and review date before acting, particularly when a customer contract, regional rule, or active incident may affect the normal workflow.

## Authoritative facts

- The contractual monthly uptime target is 99.9 percent.
- Availability below 99.9 percent earns a 10 percent service credit.
- Availability below 99.0 percent earns a 25 percent service credit.
- Total service credits are capped at 50 percent of the affected monthly fee.
