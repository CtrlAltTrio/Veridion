...
This reference explains company holidays and the process for regional substitutions. It is the controlled internal source for this topic. Northwind Systems uses it to make decisions consistently across Portland, Austin, Dublin, and remote teams. Readers should check the owner and review date before acting, particularly when a customer contract, regional rule, or active incident may affect the normal workflow.

## Authoritative facts

- Northwind observes 12 paid company holidays each calendar year.
- The annual calendar is published by 15 November for the following year.
- Employees outside the United States may substitute up to four dates for local holidays.
- Holiday substitutions require manager approval before 31 January.
...
Employees submit requests through Workday and managers respond in the same system so the decision remains auditable. People Operations answers eligibility questions and documents any legally required regional variation. A manager may plan timing for business coverage but may not reduce a stated entitlement without People approval. Payroll deadlines still apply when a request affects pay or reimbursement.
...
People Operations reviews this policy each year and before the next enrollment or planning cycle. Workday records, approval notes, and payroll reports provide the authoritative evidence. Personal medical or family details belong only in restricted People systems. Employees may ask People Operations to correct an inaccurate record without going through their manager.
