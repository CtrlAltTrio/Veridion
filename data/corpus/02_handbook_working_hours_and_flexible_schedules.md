...
This policy explains the standard workweek, collaboration window, and approval path for alternative schedules. It is the controlled internal source for this topic. Northwind Systems uses it to make decisions consistently across Portland, Austin, Dublin, and remote teams. Readers should check the owner and review date before acting, particularly when a customer contract, regional rule, or active incident may affect the normal workflow.

## Authoritative facts

- A full-time schedule is 40 hours per week.
- Core collaboration hours are 10:00 to 15:00 local time Monday through Thursday.
- Employees may shift remaining hours with manager approval recorded in Workday.
- No recurring meeting may be scheduled after 17:00 local time without participant consent.
