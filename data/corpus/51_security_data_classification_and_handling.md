...
This policy defines Public, Internal, Confidential, and Restricted information. It is the controlled internal source for this topic. Northwind Systems uses it to make decisions consistently across Portland, Austin, Dublin, and remote teams. Readers should check the owner and review date before acting, particularly when a customer contract, regional rule, or active incident may affect the normal workflow.

## Authoritative facts

- Customer content is classified Confidential by default.
- Authentication secrets and private keys are Restricted.
- Restricted data may not be sent through ordinary email.
- Every repository containing Restricted data requires an owner review each quarter.
