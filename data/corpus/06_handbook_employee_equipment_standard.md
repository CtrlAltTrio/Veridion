...
This standard describes issued computers, peripherals, replacement timing, and return obligations. It is the controlled internal source for this topic. Northwind Systems uses it to make decisions consistently across Portland, Austin, Dublin, and remote teams. Readers should check the owner and review date before acting, particularly when a customer contract, regional rule, or active incident may affect the normal workflow.

## Authoritative facts

- The standard laptop replacement cycle is 36 months.
- Each employee may expense up to $600 for one monitor with manager approval.
- Lost equipment must be reported to security within 30 minutes of discovery.
- Departing employees return all equipment within five calendar days of their final workday.
