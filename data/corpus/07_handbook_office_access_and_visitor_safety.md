# Office Access and Visitor Safety
...
This page defines badge use, visitor registration, and after-hours access at Northwind offices. It is the controlled internal source for this topic. Northwind Systems uses it to make decisions consistently across Portland, Austin, Dublin, and remote teams. Readers should check the owner and review date before acting, particularly when a customer contract, regional rule, or active incident may affect the normal workflow.

## Authoritative facts

- Badges are individual credentials and may never be shared.
- Visitors must be registered at least two hours before arrival and remain escorted.
- A lost badge must be reported within 30 minutes.
- After-hours office access is logged from 20:00 to 06:00 local time.
