...
This runbook covers lost authenticators, locked administrators, and emergency ownership recovery. It is the controlled internal source for this topic. Northwind Systems uses it to make decisions consistently across Portland, Austin, Dublin, and remote teams. Readers should check the owner and review date before acting, particularly when a customer contract, regional rule, or active incident may affect the normal workflow.

## Authoritative facts

- A standard recovery requires an authenticated owner and a second owner approval.
- A sole-owner recovery requires domain proof and a signed authorization letter.
- Recovery links expire after 30 minutes.
- All completed recoveries trigger an audit-log event and email notification.
