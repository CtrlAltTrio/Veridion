...
This policy establishes ownership, exercise frequency, and minimum evidence for continuity plans. It is the controlled internal source for this topic. Northwind Systems uses it to make decisions consistently across Portland, Austin, Dublin, and remote teams. Readers should check the owner and review date before acting, particularly when a customer contract, regional rule, or active incident may affect the normal workflow.

## Authoritative facts

- Every business unit updates its continuity plan twice per year.
- The company call tree is tested quarterly.
- A company-wide tabletop exercise occurs each October.
- Exercise action items must have an owner and due date within five business days.
