...
This guide explains invoice delivery, payment terms, retry timing, and suspension safeguards. It is the controlled internal source for this topic. Northwind Systems uses it to make decisions consistently across Portland, Austin, Dublin, and remote teams. Readers should check the owner and review date before acting, particularly when a customer contract, regional rule, or active incident may affect the normal workflow.

## Authoritative facts

- Enterprise invoices use Net 30 payment terms unless the order form says otherwise.
- Card retries occur one, three, and seven days after a failed charge.
- Workspace administrators receive an email after every failed attempt.
- Service suspension may begin 10 calendar days after the original failed charge.
