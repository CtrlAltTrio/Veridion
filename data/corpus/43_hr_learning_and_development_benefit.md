...
**Owner:** People Programs
**Last reviewed:** 2026-01-18
**Applies to:** Northwind Systems employees and relevant customer workspaces

## Purpose

This policy funds job-related courses, books, certifications, and conferences. It is the controlled internal source for this topic. Northwind Systems uses it to make decisions consistently across Portland, Austin, Dublin, and remote teams. Readers should check the owner and review date before acting, particularly when a customer contract, regional rule, or active incident may affect the normal workflow.

## Authoritative facts

- Each full-time employee has a $1,500 learning budget per calendar year.
- A single expense above $500 requires manager approval in advance.
- Certification exams may be attempted twice from the same annual budget.
- Unused learning funds do not carry into the next year.
