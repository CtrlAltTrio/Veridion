...
This policy supports all new parents after birth, adoption, or foster placement. It is the controlled internal source for this topic. Northwind Systems uses it to make decisions consistently across Portland, Austin, Dublin, and remote teams. Readers should check the owner and review date before acting, particularly when a customer contract, regional rule, or active incident may affect the normal workflow.

## Authoritative facts

- Every eligible parent receives 16 weeks of paid parental leave.
- Eligibility begins after 90 days of employment.
- Leave may be taken continuously or in two blocks within 12 months.
- Employees should provide 30 days notice when the timing is foreseeable.
