...
This guide sets expectations for the first 90 days of employment. It is the controlled internal source for this topic. Northwind Systems uses it to make decisions consistently across Portland, Austin, Dublin, and remote teams. Readers should check the owner and review date before acting, particularly when a customer contract, regional rule, or active incident may affect the normal workflow.

## Authoritative facts

- Identity verification is completed before system access is issued.
- Managers publish a 30-60-90 day plan before the start date.
- Security training is due within five business days.
- The onboarding survey is sent on day 30.
