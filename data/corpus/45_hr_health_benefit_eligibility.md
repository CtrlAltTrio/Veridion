...
This page explains when medical, dental, and vision coverage begins and how enrollment works. It is the controlled internal source for this topic. Northwind Systems uses it to make decisions consistently across Portland, Austin, Dublin, and remote teams. Readers should check the owner and review date before acting, particularly when a customer contract, regional rule, or active incident may affect the normal workflow.

## Authoritative facts

- Coverage begins on the first day of the month following the employee start date.
- New hires have 30 calendar days to complete enrollment.
- A qualifying life event opens a 30-day change window.
- Northwind pays 85 percent of the employee-only medical premium.
