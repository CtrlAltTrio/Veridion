# Workspace Export and Portability
...
This page describes customer exports, supported formats, delivery, and post-termination access. It is the controlled internal source for this topic. Northwind Systems uses it to make decisions consistently across Portland, Austin, Dublin, and remote teams. Readers should check the owner and review date before acting, particularly when a customer contract, regional rule, or active incident may affect the normal workflow.

## Authoritative facts

- Workspace administrators may export records in CSV or JSON format.
- Exports are encrypted and the download link expires after 24 hours.
- A completed export is available in the audit log.
- Customers may request an export for 30 calendar days after subscription termination.
